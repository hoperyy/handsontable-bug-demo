...
Fx.implement({
    getTransition: function() {
        ...
        if ("string" == typeof e) {
            var t = e.split(":");
            e = (e = Fx.Transitions)[t[0]] || e[t[0].capitalize()],
            t[1] && (e = e["ease" + t[1].capitalize() + (t[2] ? t[2].capitalize() : "")])
        }
        return e
    }
}),
...
Fx.Transitions.extend({
    ...
    Back: function(e, t) {
        return t = t && t[0] || 1.618,
        Math.pow(e, 2) * ((t + 1) * e - t)
    },
    Bounce: function(e) {
        for (var t, n = 0,
        i = 1; 1; n += i, i /= 2) if (e >= (7 - 4 * n) / 11) {
...
Fx.Tween = new Class({
    ...
    set: function(e, t) {
        ...
        this.render(this.element, e, t, this.options.unit),
        this
    },
...
Element.Properties.tween = {
    set: function(e) {
        return this.get("tween").cancel().setOptions(e),
        this
    },
    get: function() {
...
Element.implement({
    tween: function(e, t, n) {
        return this.get("tween").start(e, t, n),
        this
    },
    fade: function() {
        ...
        t || this.eliminate("fade:flag"),
        n[e].apply(n, i);
        var o = i[i.length - 1];
        return "set" == e ? this.setStyle("visibility", 0 == o ? "hidden": "visible") : 0 != o ? n.$chain.length ? n.chain(function() {
    ...
    highlight: function(e, t) {
        t || (t = "transparent" == (t = this.retrieve("highlight:original", this.getStyle("background-color"))) ? "#fff": t);
...
Request.HTML = new Class({
    ...
    success: function(e) {
        ...
        if (n.tree = r.childNodes, n.elements = r.getElements(t.filter || "*"), t.filter && (n.tree = n.elements), t.update) {
            ...
            t.filter ? n.elements.reverse().inject(s) : s.adopt(r.getChildren())
        }
        t.evalScripts && Browser.exec(n.javascript),
...
function() {
    ...
    this.Element && Element.implement && this.Fx && Element.implement({
        chains: function(e) {
            return Array.convert(e || ["tween", "morph", "reveal"]).each(function(e) { (e = this.get(e)) && e.setOptions({
                    link: "chain"
                })
            },
            this),
...
function() {
    var e = this.Drag = new Class({
        ...
        initialize: function() {
            ...
            !("ondragstart" in document) || "FileReader" in window || e.ondragstartFixed || (document.ondragstart = Function.convert(!1), e.ondragstartFixed = !0),
            this.bound = {
        ...
        sumValues: function(e, t, n) {
            var i = {},
            r = this.options;
            for (var o in r.modifiers) r.modifiers[o] && (i[o] = e[o] + t[o] * n);
            return i
        },
        start: function(e) {
            if (!this.options.unDraggableTags.contains(e.target.get("tag"))) {
                ...
                if (!e.rightClick) {
                    ...
                    var i, r, o = this.offsetParent == window ? null: this.offsetParent;
                    for (i in t.modifiers) if (t.modifiers[i]) {
                        var s = this.element.getStyle(t.modifiers[i]);
                        if (s && !s.match(/px$/) && (r || (r = this.element.getCoordinates(o)), s = r[t.modifiers[i]]), t.style ? this.value.now[i] = (s || 0).toInt() : this.value.now[i] = this.element[t.modifiers[i]], t.invert && (this.value.now[i] *= -1), this.mouse.pos[i] = e.page[i] - this.value.now[i], n && n[i]) for (var a = 2; a--;) {
                            var l = n[i][a]; (l || 0 === l) && (this.limit[i][a] = "function" == typeof l ? l() : l)
                        }
                    }
        ...
        check: function(e) {
            ...
            Math.round(Math.sqrt(Math.pow(e.page.x - this.mouse.start.x, 2) + Math.pow(e.page.y - this.mouse.start.y, 2))) > this.options.snap && (this.cancel(), this.document.addEvents({
        ...
        render: function(e) {
            for (var t in e.modifiers) e.modifiers[t] && (this.value.now[t] = this.mouse.now[t] - this.mouse.pos[t], e.invert && (this.value.now[t] *= -1), e.limit && this.limit[t] && ((this.limit[t][1] || 0 === this.limit[t][1]) && this.value.now[t] > this.limit[t][1] ? this.value.now[t] = this.limit[t][1] : (this.limit[t][0] || 0 === this.limit[t][0]) && this.value.now[t] < this.limit[t][0] && (this.value.now[t] = this.limit[t][0])), e.grid[t] && (this.value.now[t] -= (this.value.now[t] - (this.limit[t][0] || 0)) % e.grid[t]), e.style ? this.element.setStyle(e.modifiers[t], this.value.now[t] + e.unit) : this.element[e.modifiers[t]] = this.value.now[t])
        },
        cancel: function(e) {
...
Drag.Move = new Class({
    ...
    initialize: function(e, t) {
        if (this.parent(e, t), e = this.element, this.droppables = $$(this.options.droppables), this.setContainer(this.options.container), this.options.style) {
            if ("left" == this.options.modifiers.x && "top" == this.options.modifiers.y) {
                ...
                i = e.getStyles("left", "top"); ! n || "auto" != i.left && "auto" != i.top || e.setPosition(e.getPosition(n))
            }
    ...
    calculateLimit: function() {
        ...
        a = {},
        l = {},
        c = n.getScroll(); ["top", "right", "bottom", "left"].each(function(i) {
            r[i] = e.getStyle("margin-" + i).toInt(),
            o[i] = e.getStyle("border-" + i).toInt(),
            s[i] = t.getStyle("margin-" + i).toInt(),
            a[i] = t.getStyle("border-" + i).toInt(),
            l[i] = n.getStyle("padding-" + i).toInt()
        },
        this);
        var u = e.offsetWidth + r.left + r.right,
        p = e.offsetHeight + r.top + r.bottom,
        h = 0 + c.x,
        f = 0 + c.y,
        d = i.right - a.right - u + c.x,
        y = i.bottom - a.bottom - p + c.y;
        if (this.options.includeMargins ? (h += r.left, f += r.top) : (d += r.right, y += r.bottom), "relative" == e.getStyle("position")) {
            var m = e.getCoordinates(n);
            m.left -= e.getStyle("left").toInt(),
            m.top -= e.getStyle("top").toInt(),
            h -= m.left,
            f -= m.top,
            "relative" != t.getStyle("position") && (h += a.left, f += a.top),
            d += r.left - m.left,
            y += r.top - m.top,
            t != n && (h += s.left + l.left, !l.left && h < 0 && (h = 0), f += n == document.body ? 0 : s.top + l.top, !l.top && f < 0 && (f = 0))
        } else h -= r.left,
        f -= r.top,
        t != n && (h += i.left + a.left, f += i.top + a.top);
        return {
            x: [h, d],
            y: [f, y]
        }
...
function() {
    ...
    Element.implement({
        measure: function(t) {
            if (e(this)) return t.call(this);
            for (var n = this.getParent(), i = []; ! e(n) && n != document.body;) i.push(n.expose()),
            n = n.getParent();
            var r = this.expose(),
            o = t.call(this);
            return r(),
        ...
        getComputedSize: function(e) {
            e && e.plains && (e.planes = e.plains);
            var t, n = {},
            i = {
                width: 0,
                height: 0
            };
            return "vertical" == (e = Object.merge({
            ...
            e)).mode ? (delete i.width, delete e.planes.width) : "horizontal" == e.mode && (delete i.height, delete e.planes.height),
            function(e, t) {
                var n = [];
                return Object.each(t,
                function(t) {
                ...
                n
            } (e.styles, e.planes).each(function(e) {
                n[e] = this.getStyle(e).toInt()
            },
            this),
            Object.each(e.planes,
            function(e, r) {
                var o = r.capitalize(),
                s = this.getStyle(r);
                "auto" != s || t || (t = this.getDimensions()),
                s = n[r] = "auto" == s ? t[r] : s.toInt(),
                i["total" + o] = s,
                e.each(function(e) {
                    var t = function(e, t) {
                        var n = 0;
    ...
    this.Sortables = new Class({
        ...
        addItems: function() {
            return Array.flatten(arguments).each(function(e) {
                ...
                }.bind(this)); (this.options.handle ? e.getElement(this.options.handle) || e: e).addEvent("mousedown", t)
            },
            this),
            this
        },
        addLists: function() {
            return Array.flatten(arguments).each(function(e) {
                this.lists.include(e),
                this.addItems(e.getChildren())
            },
            this),
            this
        },
        removeItems: function() {
            return $$(Array.flatten(arguments).map(function(e) {
                ...
                var t = e.retrieve("sortables:start");
                return (this.options.handle ? e.getElement(this.options.handle) || e: e).removeEvent("mousedown", t),
                e
            },
            this))
        },
        removeLists: function() {
            return $$(Array.flatten(arguments).map(function(e) {
                return this.lists.erase(e),
                this.removeItems(e.getChildren()),
                e
            },
            this))
        },
        getDroppableCoordinates: function(e) {
            ...
            i = {
                w: window.getScroll(),
                offsetParent: t.getScroll()
            };
            return n.x += i.offsetParent.x,
            n.y += i.offsetParent.y,
            "fixed" == t.getStyle("position") && (n.x -= i.w.x, n.y -= i.w.y),
            n
        },
        getClone: function(e, t) {
            if (!this.options.clone) return new Element(t.tagName).inject(document.body);
            if ("function" == typeOf(this.options.clone)) return this.options.clone.call(this, e, t, this.list);
            var n = t.clone(!0).setStyles({
                margin: 0,
                position: "absolute",
                visibility: "hidden",
            ...
            return n.get("html").test("radio") && n.getElements("input[type=radio]").each(function(e, n) {
                e.set("name", "clone_" + n),
                e.get("checked") && t.getElements("input[type=radio]")[n].set("checked", !0)
            }),
        ...
        getDroppables: function() {
            ...
            return this.options.constrain || e.append(this.lists).erase(this.list),
            e
        },
        insert: function(e, t) {
            var n = "inside";
            this.lists.contains(t) ? (this.list = t, this.drag.droppables = this.getDroppables()) : n = this.element.getAllPrevious().contains(t) ? "before": "after",
            this.element.inject(t, n),
            this.fireEvent("sort", [this.element, this.clone])
        },
        start: function(e, t) { ! this.idle || e.rightClick || !this.options.handle && this.options.unDraggableTags.contains(e.target.get("tag")) || (this.idle = !1, this.element = t, this.opacity = t.getStyle("opacity"), this.list = t.getParent(), this.clone = this.getClone(e, t), this.drag = new Drag.Move(this.clone, Object.merge({
            ...
            }), this.clone.inject(this.element, "before"), this.drag.start(e))
        },
        end: function() {
            this.drag.detach(),
            ...
            if (this.effect) {
                ...
                r = function() {
                    this.removeEvent("cancel", r),
                    n.destroy(),
                    e.reset()
                };
                this.effect.element = n,
                this.effect.start({
                    top: i.top,
                    left: i.left,
                    width: t.width,
        ...
        serialize: function() {
            ...
            t = this.lists.map(function(t) {
                return t.getChildren().map(e.modifier ||
                function(e) {
                    return e.get("id")
                },
                this)
            ...
            this),
            n = e.index;
            return 1 == this.lists.length && (n = 0),
            (n || 0 === n) && n >= 0 && n < this.lists.length ? t[n] : t
        }
    })
} (),
function() {
    ...
    var i = Element.prototype; [Element, Window, Document].invoke("implement", Events.Pseudos(e, i.addEvent, i.removeEvent))
} (),
DOMEvent.definePseudo("keys",
function(e, t, n) {
    var i = n[0],
    r = [],
    o = this.retrieve("$moo:keys-pressed", []),
    s = e.value;
    if ("+" != s ? r.append(s.replace("++",
    function() {
        return r.push("+"),
        ""
    }).split("+")) : r = ["+"], o.include(i.key), r.every(function(e) {
        return o.contains(e)
    }) && t.apply(this, n), this.store("$moo:keys-pressed", o), !this.retrieve("$moo:keys-keyup")) {
        var a = function(e) { (function() {
                o = this.retrieve("$moo:keys-pressed", []).erase(e.key),
                this.store("$moo:keys-pressed", o)
            }).delay(0, this)
        };
        this.store("$moo:keys-keyup", a).addEvent("keyup", a)
    }
}),
...
Elements.from = function(e, t) { (t || null == t) && (e = e.stripScripts());
    var n, i = e.match(/^\s*(?:<!--.*?-->\s*)*<(t[dhr]|tbody|tfoot|thead)/i);
    if (i) {
        n = new Element("table");
        var r = i[1].toLowerCase(); ["td", "th", "tr"].contains(r) && (n = new Element("tbody").inject(n), "tr" != r && (n = new Element("tr").inject(n)))
    }
...
function() {
    ...
    var t = this.IframeShim = new Class({
        ...
        initialize: function(e, t) {
            ...
            this.occlude() ? this.occluded: (this.setOptions(t), this.makeShim(), this)
        },
        makeShim: function() {
            if (this.options.browsers) {
                ...
                } (e = (null != this.options.zIndex || 0 === this.options.zIndex) && e > this.options.zIndex ? this.options.zIndex: e - 1) < 0 && (e = 1),
        ...
        position: function() {
            if (!t.ready || !this.shim) return this;
            var e = this.element.measure(function() {
                return this.getSize()
            });
            return void 0 != this.options.margin && (e.x = e.x - 2 * this.options.margin, e.y = e.y - 2 * this.options.margin, this.options.offset.x += this.options.margin, this.options.offset.y += this.options.margin),
            this.shim.set({
                width: e.x,
                height: e.y
            }).position({
...
function() {
    this.Mask = new Class({
        ...
        inject: function(e, t) {
            ...
            this.options.useIframeShim && (this.shim = new IframeShim(this.element, this.options.iframeShimOptions), this.addEvents({
        ...
        resize: function(e, t) {
            ...
            if (this.target == document.body) {
                ...
                i.totalHeight < r.y && (i.totalHeight = r.y),
                i.totalWidth < r.x && (i.totalWidth = r.x)
            }
            return this.element.setStyles({
                width: Array.pick([e, i.totalWidth, i.x]),
                height: Array.pick([t, i.totalHeight, i.y])
            }),
            this
        },
        show: function() {
...
Element.Properties.mask = {
    ...
    get: function() {
        ...
        return e || (e = new Mask(this, this.retrieve("mask:options")), this.store("mask", e)),
        e
    }
},
Element.implement({
...
function() {
    this.Spinner = new Class({
        ...
        render: function() {
            ...
            this.options.message && (this.msg = document.id(this.options.message) || new Element("p", this.options.messageContainer).appendText(this.options.message), this.msg.inject(this.content)),
            this.options.img && (this.img = document.id(this.options.img) || new Element("div", this.options.img), this.img.inject(this.content)),
            this.element.set("tween", this.options.fxOptions)
        },
        show: function(e) {
            return this.active ? this.chain(this.show.bind(this)) : this.hidden ? (this.target.set("aria-busy", "true"), this.active = !0, this.parent(e)) : (this.callChain.delay(20, this), this)
        },
        showMask: function(e) {
            var t = function() {
            ...
            e ? (this.parent(), t()) : (this.options.style.opacity || (this.options.style.opacity = this.element.getStyle("opacity").toFloat()), this.element.setStyles({
                display: "block",
                opacity: 0
            }).tween("opacity", this.options.style.opacity), t(), this.hidden = !1, this.fireEvent("show"), this.callChain())
        },
        hide: function(e) {
            return this.active ? this.chain(this.hide.bind(this)) : this.hidden ? (this.callChain.delay(20, this), this) : (this.target.set("aria-busy", "false"), this.active = !0, this.parent(e))
        },
        hideMask: function(e) {
...
function(e) {
    ...
    function Rn(e, t, n, i, r, o, s) {
        ...
        var l, c = 0,
        u = null,
        p = new Zr(t, e.options.tabSize),
        h = e.options.addModeClass && [null];
        for ("" == t && An(On(n, i), o); ! p.eol();) {
            if (p.pos > e.options.maxHighlightLength ? (a = !1, s && Nn(e, t, i, p.pos), p.pos = t.length, l = null) : l = An(Ln(n, p, i, h), o), h) {
                var f = h[0].name;
                f && (l = "m-" + (l ? f + " " + l: f))
            }
            if (!a || u != l) {
                for (; c < p.start;) r(c = Math.min(p.start, c + 5e3), u);
                u = l
            }
            p.start = p.pos
        }
        for (; c < p.pos;) {
            var d = Math.min(p.pos, c + 5e3);
            r(d, u),
            c = d
        }
    }
    ...
    var Gr = e.commands = {
        selectAll: function(e) {
            e.setSelection(_r(e.firstLine(), 0), _r(e.lastLine()), _o)
        },
        singleSelection: function(e) {
            e.setSelection(e.getCursor("anchor"), e.getCursor("head"), _o)
        },
        killLine: function(e) {
            Qt(e,
            function(t) {
        ...
        deleteLine: function(e) {
            ...
            function(t) {
                return {
                    from: _r(t.from().line, 0),
                    to: re(e.doc, _r(t.to().line + 1, 0))
                }
            })
        },
        ...
        goDocStart: function(e) {
            e.extendSelection(_r(e.firstLine(), 0))
        },
        goDocEnd: function(e) {
            e.extendSelection(_r(e.lastLine()))
        },
        ...
        goLineEnd: function(e) {
            e.extendSelectionsBy(function(t) {
                return function(e, t) {
                    for (var n, i = Vn(e.doc, t); n = bn(i);) i = n.find(1, !0).line,
                    t = null;
                    var r = ei(i),
                    o = r ? r[0].level % 2 ? Fi(i) : qi(i) : i.text.length;
                    return _r(null == t ? Qn(i) : t, o)
                } (e, t.head.line)
            },
            {
                origin: "+move",
        ...
        goLineLeftSmart: function(e) {
            e.extendSelectionsBy(function(t) {
                ...
                "div");
                return i.ch < e.getLine(i.line).search(/\S/) ? Ui(e, t.head) : i
            },
            So)
        },
        goLineUp: function(e) {
        ...
        transposeChars: function(e) {
            ...
            function() {
                for (var t = e.listSelections(), n = [], i = 0; i < t.length; i++) {
                    var r = t[i].head,
                    o = Vn(e.doc, r.line).text;
                    if (o) if (r.ch == o.length && (r = new _r(r.line, r.ch - 1)), r.ch > 0) r = new _r(r.line, r.ch + 1),
                    e.replaceRange(o.charAt(r.ch - 1) + o.charAt(r.ch - 2), _r(r.line, r.ch - 2), r, "+transpose");
                    else if (r.line > e.doc.first) {
                        var s = Vn(e.doc, r.line - 1).text;
                        s && e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + s.charAt(s.length - 1), _r(r.line - 1, s.length - 1), _r(r.line, 1), "+transpose")
                    }
                    n.push(new ee(r, r))
                }
                e.setSelections(n)
...
default = dr ? Jr.macDefault: Jr.pcDefault,
    e.normalizeKeyMap = function(e) {
        ...
        for (var n in e) if (e.hasOwnProperty(n)) {
            ...
            for (var r = Ti(n.split(" "), tn), o = 0; o < r.length; o++) {
                var s, a;
    ...
    var Xr = e.lookupKey = function(e, t, n, i) {
        var r = (t = nn(t)).call ? t.call(e, i) : t[e];
        if (!1 === r) return "nothing";
        if ("..." === r) return "multi";
        if (null != r && n(r)) return "handled";
        if (t.fallthrough) {
            if ("[object Array]" != Object.prototype.toString.call(t.fallthrough)) return Xr(e, t.fallthrough, n, i);
            for (var o = 0; o < t.fallthrough.length; o++) {
                var s = Xr(e, t.fallthrough[o], n, i);
                if (s) return s
            }
        }
    },
    ...
    Yr = e.keyName = function(e, t) {
        ...
        var n = qo[e.keyCode],
        i = n;
        return null != i && !e.altGraphKey && (e.altKey && "Alt" != n && (i = "Alt-" + i), (vr ? e.metaKey: e.ctrlKey) && "Ctrl" != n && (i = "Ctrl-" + i), (vr ? e.ctrlKey: e.metaKey) && "Cmd" != n && (i = "Cmd-" + i), !t && e.shiftKey && "Shift" != n && (i = "Shift-" + i), i)
    };
    e.fromTextArea = function(t, n) {
        ...
        if (t.form && (yo(t.form, "submit", i), !n.leaveSubmitMethodAlone)) {
            var o = t.form,
            s = o.submit;
            try {
        ...
        n.finishInit = function(e) {
            ...
            e.toTextArea = function() {
                ...
                t.style.display = "",
                t.form && (go(t.form, "submit", i), "function" == typeof t.form.submit && (t.form.submit = s))
            }
        },
    ...
    Zr.prototype = {
        ...
        column: function() {
            return this.lastColumnPos < this.start && (this.lastColumnValue = Co(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start),
            this.lastColumnValue - (this.lineStart ? Co(this.string, this.lineStart, this.tabSize) : 0)
        },
        indentation: function() {
            return Co(this.string, null, this.tabSize) - (this.lineStart ? Co(this.string, this.lineStart, this.tabSize) : 0)
        },
    ...
    to.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            o = 0; o < this.lines.length; ++o) {
                var s = this.lines[o],
                a = ln(s.markedSpans, this);
                e && !this.collapsed ? ut(e, Qn(s), "text") : e && (null != a.to && (r = Qn(s)), null != a.from && (i = Qn(s))),
                s.markedSpans = function(e, t) {
                    for (var n, i = 0; i < e.length; ++i) e[i] != t && (n || (n = [])).push(e[i]);
                    return n
                } (s.markedSpans, a),
                null == a.from && this.collapsed && !Sn(this.doc, s) && e && Xn(s, Ze(e.display))
            }
            if (e && this.collapsed && !e.options.lineWrapping) for (o = 0; o < this.lines.length; ++o) {
                var l = wn(this.lines[o]),
                u = c(l);
                u > e.display.maxLineLength && (e.display.maxLine = l, e.display.maxLineLength = u, e.display.maxLineChanged = !0)
            }
            null != i && e && this.collapsed && ct(e, i, r + 1),
            this.lines.length = 0,
            this.explicitlyCleared = !0,
            this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && me(e.doc)),
            e && mi(e, "markerCleared", e, this),
            t && nt(e),
    ...
    to.prototype.find = function(e, t) {
        ...
        for (var n, i, r = 0; r < this.lines.length; ++r) {
            var o = this.lines[r],
            s = ln(o.markedSpans, this);
            if (null != s.from && (n = _r(t ? o: Qn(o), s.from), -1 == e)) return n;
            if (null != s.to && (i = _r(t ? o: Qn(o), s.to), 1 == e)) return i
        }
        return n && {
            from: n,
            to: i
    ...
    to.prototype.changed = function() {
        ...
        function() {
            ...
            r = Qn(e.line),
            o = Ne(n, r);
            if (o && (Be(o), n.curOp.selectionChanged = n.curOp.forceUpdate = !0), n.curOp.updateMaxLine = !0, !Sn(t.doc, i) && null != t.height) {
                var s = t.height;
                t.height = null;
                var a = En(t) - s;
                a && Xn(i, i.height + a)
    ...
    to.prototype.attachLine = function(e) {
        if (!this.lines.length && this.doc.cm) {
            ...
            t.maybeHiddenMarkers && -1 != Ci(t.maybeHiddenMarkers, this) || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this)
        }
        this.lines.push(e)
    },
    to.prototype.detachLine = function(e) {
        if (this.lines.splice(Ci(this.lines, e), 1), !this.lines.length && this.doc.cm) {
            var t = this.doc.cm.curOp; (t.maybeHiddenMarkers || (t.maybeHiddenMarkers = [])).push(this)
        }
    };
    var eo = 0,
    no = e.SharedTextMarker = function(e, t) {
        this.markers = e,
        this.primary = t;
    ...
    lo.prototype = Mi(qn.prototype, {
        ...
        setValue: st(function(e) {
            var t = _r(this.first, 0),
            n = this.first + this.size - 1;
            Wt(this, {
                from: t,
                to: _r(n, Vn(this, n).text.length),
        ...
        getLineHandleVisualStart: function(e) {
            return "number" == typeof e && (e = Vn(this, e)),
            wn(e)
        },
        lineCount: function() {
            return this.size
        ...
        setCursor: st(function(e, t, n) {
            pe(this, re(this, "number" == typeof e ? _r(e, t || 0) : e), null, n)
        }),
        setSelection: st(function(e, t, n) {
            pe(this, re(this, e), re(this, t || e), n)
        }),
        extendSelection: st(function(e, t, n) {
        ...
        extendSelectionsBy: st(function(e, t) {
            ce(this, se(this, Ti(this.sel.ranges, e)), t)
        }),
        setSelections: st(function(e, t, n) {
            if (e.length) {
                for (var i = 0,
                r = []; i < e.length; i++) r[i] = new ee(re(this, e[i].anchor), re(this, e[i].head));
                null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
                fe(this, te(r, t), n)
            }
        }),
        addSelection: st(function(e, t, n) {
            var i = this.sel.ranges.slice(0);
            i.push(new ee(re(this, e), re(this, t || e))),
            fe(this, te(i, i.length - 1), n)
        }),
        ...
        getSelections: function(e) {
            for (var t = [], n = this.sel.ranges, i = 0; i < n.length; i++) {
                var r = Gn(this, n[i].from(), n[i].to()); ! 1 !== e && (r = r.join(e || this.lineSeparator())),
                t[i] = r
            }
            return t
        },
        ...
        replaceSelections: st(function(e, t, n) {
            ...
            for (var a = t && "end" != t &&
            function(e, t, n) {
                for (var i = [], r = _r(e.first, 0), o = r, s = 0; s < t.length; s++) {
                    var a = t[s],
                    l = Dt(a.from, r, o),
                    c = Dt(Dr(a), r, o);
                    if (r = a.to, o = c, "around" == n) {
                        var u = e.sel.ranges[s],
                        p = kr(u.head, u.anchor) < 0;
                        i[s] = new ee(p ? c: l, p ? l: c)
                    } else i[s] = new ee(l, l)
                }
                return new Z(i, e.sel.primIndex)
            } (this, i, t), o = i.length - 1; o >= 0; o--) Wt(this, i[o]);
            a ? he(this, a) : this.cm && Vt(this.cm)
        }),
        undo: st(function() {
            Bt(this, "undo")
        }),
        ...
        addLineClass: st(function(e, t, n) {
            return Xt(this, e, "gutter" == t ? "gutter": "class",
            function(e) {
        ...
        removeLineClass: st(function(e, t, n) {
            return Xt(this, e, "gutter" == t ? "gutter": "class",
            function(e) {
                var i = "text" == t ? "textClass": "background" == t ? "bgClass": "gutter" == t ? "gutterClass": "wrapClass",
                r = e[i];
        ...
        addLineWidget: st(function(e, t, n) {
            return function(e, t, n, i) {
                var r = new io(e, n, i),
                o = e.cm;
                ...
                function(t) {
                    ...
                    if (null == r.insertAt ? n.push(r) : n.splice(Math.min(n.length - 1, Math.max(0, r.insertAt)), 0, r), r.line = t, o && !Sn(e, t)) {
                        var i = Zn(t) < e.scrollTop;
                        Xn(t, t.height + En(r)),
                        i && Ut(o, null, r.height),
        ...
        markText: function(e, t, n) {
            return rn(this, re(this, e), re(this, t), n, n && n.type || "range")
        },
        setBookmark: function(e, t) {
            ...
            return e = re(this, e),
            rn(this, e, e, n, "bookmark")
        },
        findMarksAt: function(e) {
            var t = [],
            n = Vn(this, (e = re(this, e)).line).markedSpans;
        ...
        copy: function(e) {
            var t = new lo(Jn(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep);
        ...
        linkedDoc: function(e) {
            ...
            var i = new lo(Jn(this, t, n), e.mode || this.modeOption, t, this.lineSep);
            ...
            function(e, t) {
                for (var n = 0; n < t.length; n++) {
                    ...
                    s = e.clipPos(r.to);
                    if (kr(o, s)) {
                        var a = rn(e, o, s, i.primary, i.primary.type);
                        i.markers.push(a),
                        a.parent = i
                    }
                }
        ...
        unlinkDoc: function(t) {
            ...
            if (t.history == this.history) {
                ...
                t.history.done = li(this.history.done, i),
                t.history.undone = li(this.history.undone, i)
            }
        },
